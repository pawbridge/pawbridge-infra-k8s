{{- define "animal-service.postgresqlContract" -}}
...
{{- $pool := int (default "0" .Values.env.SPRING_DATASOURCE_HIKARI_MAXIMUM_POOL_SIZE) -}}
{{- if or (lt $pool 1) (gt $pool 10) -}}{{ fail "PostgreSQL service connection budget exceeded" }}{{- end -}}
...
{{- $idle := int (default "0" .Values.env.SPRING_DATASOURCE_HIKARI_MINIMUM_IDLE) -}}
